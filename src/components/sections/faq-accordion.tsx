        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 w-full">
          {t.faq.items.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-white/5 border border-gray-300 dark:border-gray-700 hover:border-blue-400/50 dark:hover:border-blue-500/30 transition-all flex flex-col justify-between"
              >
                <button
                  type="button"
