  ...
  return (
    <div className="wrapper">
      <div className="max-w-[1016px] relative z-30 mx-auto pt-14 pb-16">
        <p className="text-center text-gray-500 dark:text-white/60 text-sm sm:text-base font-medium">
          Impulsando la prospección de equipos comerciales en toda Iberoamérica
        </p>
        <div className="flex flex-wrap justify-center items-center gap-7 md:gap-14 mt-8">
          <Image
