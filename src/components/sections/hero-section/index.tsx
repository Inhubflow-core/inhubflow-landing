  ...
  return (
    <section className="pt-8 sm:pt-16 lg:pt-20 pb-12 sm:pb-16 relative overflow-hidden bg-gradient-to-b from-[#FFFFFF] via-[#F6F4FE] to-[#ECE7FE] dark:from-[#0F172A] dark:via-[#171F2E] dark:to-[#1E293B]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div>
          <div className="max-w-[820px] mx-auto">
            <div className="text-center pb-8 sm:pb-12 lg:pb-16">
              ...
              {/* Mobile & Tablet Outbound Sequence Pills (< 1280px) */}
        ...
        {/* Desktop Floating Badges (Visible only on XL screens >= 1280px, placed in outer margins) */}
        <div className="hidden xl:block pointer-events-none select-none">
          {/* Badge 1: Visitar Perfil (Top Left - well outside text margin) */}
          <div className="absolute top-10 -left-4 2xl:-left-12 floating-1 w-[205px] h-12 flex items-center gap-3 px-4.5 rounded-full bg-white/95 dark:bg-gray-800/95 border border-sky-200/80 dark:border-sky-800/60 shadow-[0_8px_25px_rgba(10,102,194,0.18)] backdrop-blur-md">
          ...
          {/* Badge 2: Solicitar Conexión (Bottom Left - well outside text margin) */}
          <div className="absolute -left-6 2xl:-left-16 top-[330px] floating-2 w-[215px] h-12 flex items-center gap-3 px-4.5 rounded-full bg-white/95 dark:bg-gray-800/95 border border-indigo-200/80 dark:border-indigo-800/60 shadow-[0_8px_25px_rgba(99,102,241,0.18)] backdrop-blur-md">
          ...
          {/* Badge 3: Enviar Mensaje (Top Right - well outside text margin) */}
          <div className="absolute -right-4 2xl:-right-12 top-14 floating-3 w-[205px] h-12 flex items-center gap-3 px-4.5 rounded-full bg-white/95 dark:bg-gray-800/95 border border-sky-200/80 dark:border-sky-800/60 shadow-[0_8px_25px_rgba(10,102,194,0.18)] backdrop-blur-md">
            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#0A66C2] text-white shadow-sm shadow-blue-500/40">
              <svg className="w-4.5 h-4.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z" />
              </svg>
          ...
          {/* Badge 4: Cold E-mail (Bottom Right - well outside text margin) */}
          <div className="absolute top-[340px] -right-6 2xl:-right-16 floating-4 w-[205px] h-12 flex items-center gap-3 px-4.5 rounded-full bg-white/95 dark:bg-gray-800/95 border border-indigo-200/80 dark:border-indigo-800/60 shadow-[0_8px_25px_rgba(99,102,241,0.18)] backdrop-blur-md">
