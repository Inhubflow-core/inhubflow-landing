    ...
    <section className="pt-12 sm:pt-20 pb-16 relative overflow-hidden bg-gradient-to-b from-[#FFFFFF] via-[#F6F4FE] to-[#ECE7FE] dark:from-[#0F172A] dark:via-[#171F2E] dark:to-[#1E293B]">
      <div className="max-w-[120rem] mx-auto relative">
        ...
        <div className="max-[1100px]:hidden pointer-events-none select-none">
          ...
          <div className="absolute top-16 left-10 lg:left-14 floating-1 flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/90 dark:bg-gray-800/90 border border-emerald-200/80 dark:border-emerald-800/60 shadow-[0_8px_30px_rgb(37,211,102,0.15)] backdrop-blur-md">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#25D366] text-white shadow-sm shadow-emerald-500/40">
            ...
            <span className="text-xs font-bold text-gray-800 dark:text-gray-100">WhatsApp</span>
            <span className="absolute -bottom-1.5 right-6 w-2.5 h-2.5 bg-[#25D366] rotate-45 rounded-[2px]" />
          </div>

          {/* Badge 2: Instagram (Bottom Left) */}
          <div className="absolute left-[100px] top-[320px] max-[1240px]:left-[40px] floating-2 flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/90 dark:bg-gray-800/90 border border-pink-200/80 dark:border-pink-800/60 shadow-[0_8px_30px_rgb(225,48,108,0.15)] backdrop-blur-md">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white shadow-sm shadow-pink-500/40">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="text-xs font-bold text-gray-800 dark:text-gray-100">Instagram</span>
            <span className="absolute -top-1.5 right-6 w-2.5 h-2.5 bg-[#dc2743] rotate-45 rounded-[2px]" />
          </div>

          {/* Badge 3: LinkedIn (Top Right) */}
          <div className="absolute right-10 lg:right-16 top-[110px] floating-3 flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/90 dark:bg-gray-800/90 border border-sky-200/80 dark:border-sky-800/60 shadow-[0_8px_30px_rgb(10,102,194,0.15)] backdrop-blur-md">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#0A66C2] text-white shadow-sm shadow-blue-500/40">
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
              </svg>
            </span>
            <span className="text-xs font-bold text-gray-800 dark:text-gray-100">LinkedIn</span>
            <span className="absolute -bottom-1.5 left-6 w-2.5 h-2.5 bg-[#0A66C2] rotate-45 rounded-[2px]" />
          </div>

          {/* Badge 4: Cold E-mail (Bottom Right) */}
          <div className="absolute top-[330px] right-[140px] max-[1240px]:right-[50px] max-[1350px]:right-[100px] floating-4 flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/90 dark:bg-gray-800/90 border border-indigo-200/80 dark:border-indigo-800/60 shadow-[0_8px_30px_rgb(99,102,241,0.15)] backdrop-blur-md">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-sm shadow-indigo-500/40">
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                <rect width="20" height="16" x="2" y="4" rx="2" />
                <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
              </svg>
            </span>
            <span className="text-xs font-bold text-gray-800 dark:text-gray-100">Cold E-mail</span>
