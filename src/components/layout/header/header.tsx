        ...
        <div className="flex items-center justify-between lg:grid lg:grid-cols-[1fr_auto_1fr]">
          ...
          <div className="flex items-center gap-2 sm:gap-3 justify-end">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-xs sm:text-sm hidden xl:block font-semibold text-gray-700 dark:text-gray-300 hover:text-blue-600 transition-colors"
            >
              {t.nav.clientAccess}
            </a>
            ...
            <a
              href="#pricing"
              className="hidden sm:inline-flex items-center px-4 sm:px-5 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-xs sm:text-sm font-bold text-white rounded-full transition-all duration-200 shadow-sm"
            >
              {t.nav.startNow}
            </a>
