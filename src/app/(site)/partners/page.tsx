...
export default function PartnersPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#FFFFFF] via-[#F6F4FE] to-[#ECE7FE] text-gray-900 overflow-hidden selection:bg-indigo-600 selection:text-white">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[650px] pointer-events-none overflow-hidden z-0">
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[750px] h-[450px] bg-gradient-to-b from-blue-200/50 via-indigo-200/30 to-transparent blur-[120px] rounded-full" />
        <div className="absolute top-40 -left-20 w-96 h-96 bg-indigo-200/40 blur-[100px] rounded-full" />
        <div className="absolute top-60 -right-20 w-96 h-96 bg-violet-200/40 blur-[100px] rounded-full" />
      </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <select
                    ...
                    className="bg-gray-50 border border-gray-300 text-gray-900 font-bold text-lg rounded-xl px-4 py-3 focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600/20 cursor-pointer w-28"
                  >
