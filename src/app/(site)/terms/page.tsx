        ...
        <div className="mb-12 p-6 sm:p-8 rounded-3xl bg-gray-50/80 border border-gray-200/90">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {current.summaryItems.map((item, idx) => (
              <div
                key={idx}
                className="p-4 rounded-2xl bg-white border border-gray-200/80 hover:border-indigo-400 transition duration-200"
              >
          ...
          <aside className="sticky top-24 hidden lg:block p-4 rounded-2xl bg-white border border-gray-200">
            ...
            <div className="mt-6 pt-5 border-t border-gray-100 px-2">
              ...
              <a
                ...
                className="block text-center text-xs font-bold px-3 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white transition cursor-pointer"
              >
                {current.contactBtn}
              </a>
            </div>
