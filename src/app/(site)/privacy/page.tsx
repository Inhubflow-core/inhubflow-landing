      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="mb-12 p-6 sm:p-8 rounded-3xl bg-gray-50/80 border border-gray-300 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {current.summaryItems.map((item, idx) => (
              <div
                key={idx}
                className="p-4 rounded-2xl bg-white border border-gray-200/80 hover:border-emerald-400 transition duration-200"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8 xl:gap-12 items-start">
          ...
          <aside className="sticky top-24 hidden lg:block p-4 rounded-2xl bg-white border border-gray-300 dark:border-gray-700">
            ...
            <div className="mt-6 pt-5 border-t border-gray-300 dark:border-gray-700 px-2">
              ...
              <a
                ...
                className="block text-center text-xs font-bold px-3 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white transition cursor-pointer"
              >
                {current.contactBtn}
              </a>
            </div>
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            ...
            <section
              id="aiPolicy"
              className="p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-indigo-50/70 via-purple-50/40 to-white border border-indigo-200/80"
            >
            ...
            >
              ...
              <div className="p-5 rounded-2xl bg-gradient-to-r from-emerald-50/90 via-teal-50/60 to-gray-50 border border-emerald-200/80 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-2.5 flex-wrap">
                  ...
                  <Link
                    href="/terms"
                    className="px-4 py-2.5 rounded-xl bg-white hover:bg-gray-100 text-gray-800 font-semibold text-xs transition border border-gray-300"
                  >
