...
const dictionaries = {
  es: {
    ...
    hero: {
      subheading: 'AI-POWERED INTENT SIGNALS & AUTONOMOUS SDR SUITE',
      title1: 'Detecta Señales de Intención de Compra y Llena tu Agenda B2B con',
      titleHighlight: 'Radar de Señales y Asistentes SDR de IA',
      description:
        'Monitorea prospectos activos interactuando con tu competencia, activa secuencias multicanal en el momento exacto y delega el agendamiento 24/7 en tu Asistente SDR con IA.',
      ...
      badge1: 'Radar de Señales Activo',
      badge2: 'Calificación con IA',
      badge3: 'Atención Multicanal',
      badge4: 'Agendar Reunión',
      chatSender: 'Director Comercial (LinkedIn)',
      chatTime: '10:42 AM',
      chatMsg1: 'Hola, vi tu mensaje. ¿Cómo ayuda su sistema a captar prospectos con intención de compra real?',
      chatAgent: 'InHubFlow SDR IA',
      chatMsg2: '¡Hola Marcos! Nuestro Radar detecta prospectos comentando posts de tu competencia o cambiando de cargo en tu ICP, y activa secuencias personalizadas. Cuando muestran interés, califico sus necesidades y agendo la reunión en tu Calendly.',
      chatMsg3: '¡Brutal! Justo buscamos dejar de prospectar en frío. ¿Podemos agendar una demo mañana?',
      showcaseTitle: 'Radar de Señales + Secuencias Multicanal + SDR de IA 24/7',
      logosTitle: 'Optimizando la prospección basada en intención y ventas de equipos en toda Iberoamérica',
    },
    features: {
    ...
    partnersPage: {
      ...
      calcCardTitle: 'Calculadora de Ganancias Mensuales',
      calcHello: '¿Cuánto podría ganar con',
  ...
  'pt-BR': {
    ...
    hero: {
      subheading: 'AI-POWERED INTENT SIGNALS & AUTONOMOUS SDR SUITE',
      title1: 'Detecte Sinais de Intenção de Compra e Lote sua Agenda B2B com',
      titleHighlight: 'Radar de Sinais e Assistentes SDR de IA',
      description:
        'Monitore prospects ativos interagindo com seus concorrentes, acione sequências multicanais no momento exato e delegue agendamentos 24/7 ao seu Assistente SDR com IA.',
      ctaPrimary: 'Começar Teste Grátis',
      ctaSecondary: 'Explorar Radar de Sinais',
      guarantee: 'Sem cartão obrigatório para demo • Compatível com LinkedIn Free, Premium e Sales Nav • Configuração em 2 minutos',
      badge1: 'Radar de Sinais Ativo',
      badge2: 'Qualificação com IA',
      badge3: 'Atendimento Multicanal',
      badge4: 'Agendar Reunião',
      chatSender: 'Diretor Comercial (LinkedIn)',
      chatTime: '10:42',
      chatMsg1: 'Olá, vi sua mensagem. Como a plataforma ajuda a captar prospects com real intenção de compra?',
      chatAgent: 'InHubFlow SDR IA',
      chatMsg2: 'Olá Marcos! Nosso Radar detecta prospects comentando em posts de concorrentes ou mudando de cargo no seu ICP e aciona sequências personalizadas. Quando demonstram interesse, qualifico suas necessidades e agendo a reunião no seu Calendly.',
      chatMsg3: 'Incrível! Queremos muito parar com prospecção fria. Conseguimos fazer uma demo amanhã?',
      showcaseTitle: 'Radar de Sinais + Sequências Multicanais + SDR de IA 24/7',
      logosTitle: 'Otimizando a prospecção baseada em intenção e vendas de equipes em toda a Ibero-América',
    },
    features: {
    ...
    partnersPage: {
      ...
      calcCardTitle: 'Calculadora de Ganhos Mensais',
      calcHello: 'Quanto eu poderia ganhar com',
  ...
  en: {
    ...
    hero: {
      subheading: 'AI-POWERED INTENT SIGNALS & AUTONOMOUS SDR SUITE',
      title1: 'Detect Real Buying Intent Signals & Fill Your Pipeline with',
      titleHighlight: 'Signal Radar & Autonomous AI SDRs',
      description:
        'Monitor active prospects interacting with competitors or changing roles, trigger multichannel sequences at the exact buying moment, and delegate 24/7 booking to your AI SDR.',
      ctaPrimary: 'Start Free Trial',
      ctaSecondary: 'Explore Signal Radar',
      guarantee: 'No credit card required for demo • Compatible with Free, Premium & Sales Nav • 2-minute setup',
      badge1: 'Active Signal Radar',
      badge2: 'AI Qualification',
      badge3: 'Multichannel Support',
      badge4: 'Schedule Meeting',
      chatSender: 'Sales Director (LinkedIn)',
      chatTime: '10:42 AM',
      chatMsg1: 'Hi! I saw your message. How does your platform capture prospects with real buying intent?',
      chatAgent: 'InHubFlow AI SDR',
      chatMsg2: 'Hi Mark! Our Radar detects prospects engaging with competitor posts or newly hired in your ICP, triggering personalized sequences. When they show interest, I qualify them and book a meeting on your Calendly.',
      chatMsg3: 'Game changer! We definitely want to stop cold outreach. Can we book a quick demo tomorrow?',
      showcaseTitle: 'Intent Signal Radar + Multichannel Sequences + 24/7 AI SDR',
      logosTitle: 'Powering intent-driven outbound and high-growth sales teams worldwide',
    },
    features: {
    ...
    partnersPage: {
      ...
      calcCardTitle: 'Monthly Earnings Calculator',
      calcHello: 'How much could I earn with',
