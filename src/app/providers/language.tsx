...
const dictionaries = {
  es: {
    ...
    partnersPage: {
      ...
      heroTitle1: 'Gana comisiones de por vida compartiendo ',
      heroTitleHighlight: 'InHubFlow.',
      heroSubtitle:
        'Conviértete en Partner Oficial de InHubFlow, la mejor suite de prospección B2B y ventas con IA del mercado. Gana hasta el 50% de las compras de tus referidos. Empieza ya.',
      heroCta: 'Hazte Partner Oficial',
      heroSubNote: 'Aprobación rápida • Cupón 20% OFF para tus clientes',
      ...
      calcClientsSuffix: '¿Afiliados / Clientes?',
      calcPlanLabel: 'Plan promedio de tus clientes:',
      calcResultPrefix: 'Podría ganar',
      calcResultSuffix: '¡al mes!',
      calcPassiveNote: 'Ingresos 100% recurrentes mes a mes mientras tus referidos continúen activos.',
  ...
  'pt-BR': {
    ...
    partnersPage: {
      ...
      heroTitle1: 'Ganhe comissões vitalícias compartilhando o ',
      heroTitleHighlight: 'InHubFlow.',
      heroSubtitle:
        'Torne-se Parceiro Oficial do InHubFlow, a melhor suíte de prospecção B2B e vendas com IA do mercado. Ganhe até 50% das compras dos seus indicados. Comece já.',
      heroCta: 'Seja Parceiro Oficial',
      heroSubNote: 'Aprovação rápida • Cupom 20% OFF para seus clientes',
      ...
      calcPassiveNote: 'Renda 100% recorrente mês a mês enquanto seus indicados continuarem ativos.',
  ...
  en: {
    ...
    partnersPage: {
      ...
      heroTitle1: 'Earn lifetime recurring commissions sharing ',
      heroTitleHighlight: 'InHubFlow.',
      heroSubtitle:
        'Become an Official InHubFlow Partner, the most powerful AI B2B sales and prospecting suite on the market. Earn up to 50% of your referrals purchases for life. Get started now.',
      heroCta: 'Become an Official Partner',
      heroSubNote: 'Fast approval • 20% OFF discount link for your clients',
      ...
      calcClientsSuffix: 'Referrals / Clients?',
      calcPlanLabel: 'Average subscription plan of your clients:',
      calcResultPrefix: 'You could earn',
      calcResultSuffix: '/ month!',
      calcPassiveNote: '100% passive and recurring monthly income as long as your referred clients stay active.',
